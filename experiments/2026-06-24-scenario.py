...
def main() -> int:
    ...
    # 3. 业务输入
    user_query = (
        "我是一家年收入 10 亿元的 SaaS 公司的 CTO，"
        "公司有 200 名软件工程师，业务稳定但增长见顶。"
        "董事会要求我在 6 个月内建立 AI 能力，预算 1500 万元人民币。"
        "请基于团队现状与预算约束，给出一份完整的转型路线图，"
        "包含：能力模型、招聘策略、培训路径、首批 AI 产品方向、关键里程碑与风险评估。"
        "如果涉及预算分配等具体数字计算，请调用 calculator 工具确保数字准确。"
    )
